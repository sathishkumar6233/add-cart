...
const Header = () => {
  ...
  return (
    <header className='flex justify-evenly items-center  mb-5 py-5' style={bgColor}>
        <Link to="/" className='text-xl font-semibold'>Home</Link>
        <Link to="/" className='text-xl font-semibold'>About</Link>
        <Link to="/" className='text-xl font-semibold'>Chair</Link>
        <Link to="/" className='text-xl font-semibold'>Contact</Link>
